    ...
    <section className="smm-hero">
      <div className="smm-left">
        ...
        <h1 className="smm-title">
          Create a <span className="accent">Visual Identity</span><br />
          That Stands Out<br />
          <span className="accent">Design Experiences That Leave a Lasting Impression</span>
        </h1>

        <p className="smm-desc">
          Our creative design solutions focus on consistency, clarity, and brand recognition. From digital creatives to branding assets, we help businesses communicate professionally and memorably.
        </p>
      </div>
...
// export function SecondSlideCreativeDesign() {
...
//           <h2>
//             Why <span>Choose us</span> for your Creative Design Services?
//           </h2>


//           <p>
//             <strong>Concept-Driven Creative Design</strong><br />
//             Our creative design approach begins with strong ideas and clear
//             purpose. We craft visuals that align with your brand story, ensuring
//             consistency and clarity across all digital touchpoints.
//           </p>

//           <p>
//             <strong>Design That Engages & Performs</strong><br />
//             Beyond aesthetics, our designs are created with usability and impact
//             in mind. Thoughtful layouts and audience-focused visuals help drive
//             engagement and strengthen brand recognition.
//           </p>

//           <p>
//             <strong>Consistent Brand Expression</strong><br />
//             We maintain a unified visual language so your brand looks
//             professional, recognizable, and trustworthy on every platform.
//           </p>

//           <p>
//             <strong>Purposeful Visual Communication</strong><br />
//             Every design element is created to convey the right message clearly
//             and effectively, helping your audience connect with your brand.
//           </p>
//         </div>
...
@media(max-width:900px){
  ...
  <span className="brand-gradient">Creative Design</span>
  <span className="brand-white">?</span>
</h2>

          <p>
           Creative design is the visual expression of your brand’s identity across digital platforms. It includes layouts, graphics, visuals, and design elements that communicate your message clearly and attract attention.
          </p>

          <p>
            Our creative design process blends aesthetics with purpose. Every design choice is made to support brand consistency, usability, and engagement—helping your business stand out while maintaining clarity and professionalism.
          </p>
        </div>
...
export function ServicesGridCreativeDesign() {
  useEffect(() => {
    const css = `
      .services-wrap{
        // padding:110px 7vw;
 ...
 const services = [
  {
    ...
    desc:
      "Creative concepts that align visuals with your brand story.",
    icon: "💡"
  },
  {
    title: "Brand Design Systems",
    desc:
      "Consistent design frameworks for colors, typography, and layouts.",
    icon: "🎨"
  },
  {
    title: "Marketing & Campaign Creatives",
    desc:
      "High-impact designs for ads, banners, and digital campaigns.",
    icon: "📢"
  },
  {
    title: "Social & Content Design",
    desc:
      "Scroll-ready creatives optimized for social media platforms.",
    icon: "📱"
  },
  {
    title: "UI Visual Design",
    desc:
      "Aesthetic, user-focused interfaces that enhance usability.",
    icon: "🧩"
  },
  {
    title: "Design Quality & Consistency",
    desc:
      "Attention to detail ensuring visual clarity across all touchpoints.",
    icon: "✨"
  }
];
...
export function WhyCreativeDesignHeroDark() {
    ...
    <section className="seo-hero-dark" ref={ref}>
      <div className="seo-hero-grid">
        ...
        <div className="seo-left">
          <h1>
            Why <span>Creative Design</span>?
          </h1>

          <li>
            Creative design brings your brand to life through visuals that
            communicate clearly and connect emotionally with your audience.
            Strong design builds recognition, trust, and a lasting brand identity.
          </li>

          <li>
            Beyond aesthetics, effective creative design improves usability and
            engagement. Strategic visuals guide users, reinforce messaging, and
            create memorable experiences that drive interaction and real
            business impact.
          </li>
        </div>
...
// 5
export function FAQCreativeDesign() {
...
.home-faq-cta p{
  ...
  const faqs = [
  {
    q: "What does your creative design service include?",
    a: "Our creative design covers visual concepts, brand creatives, marketing designs, and UI visuals for digital platforms."
  },
  {
    q: "Do you design for both digital and marketing needs?",
    a: "Yes. We create designs for websites, social media, ads, campaigns, and other digital marketing materials."
  },
  {
    q: "Will the designs match my brand identity?",
    a: "Absolutely. All designs are created to align with your brand colors, tone, and visual guidelines."
  },
  {
    q: "How many design revisions are included?",
    a: "We include a defined number of revisions to ensure the final designs meet your expectations."
  },
  {
    q: "How do we get started with creative design?",
    a: "Contact us with your requirements, and we’ll discuss concepts, timelines, and next steps."
  }
];
