    ...
    <section className="why-orbit-dark" ref={sectionRef}>
      <div className="why-dark-grid">
        ...
        <div className="why-dark-left">
          <h2>
            Why <span>Choose us</span> for your SEO Services?
          </h2>
          <li><strong>Strategy-Driven SEO Approach</strong></li>
          <p>
           We create customized SEO strategies based on your business goals, industry, and target audience not generic tactics.
          </p>
          <li><strong>High-Intent Keyword Research</strong></li>
          <p>We identify and target keywords your potential customers are actively searching for, driving quality traffic that converts.</p>
          <li><strong>On-Page & Technical SEO Excellence</strong></li>
          <p>From site structure and content optimization to speed, indexing, and crawlability, we optimize every critical SEO factor.</p>
          <li><strong>Local & Organic Search Visibility</strong></li>
          <p>Our SEO solutions help you rank higher in local searches and organic results, increasing visibility and brand trust.</p>
        </div>
